    ...
    <>
        ...
        <div className="relative mx-auto max-w-7xl px-4 py-14 sm:px-6 sm:py-20 lg:px-8">
          <Reveal>
            <div className="mx-auto max-w-2xl text-center">
              <span className="mb-4 inline-flex items-center gap-1.5 rounded-full border border-metallic-bronze-top/40 bg-metallic-emerald-deep/60 px-4 py-1.5 font-mono text-xs font-semibold uppercase tracking-[0.2em] text-metallic-bronze-top"><BadgeDollarSign className="h-3.5 w-3.5" /> Transparent Pricing</span>
      ...
      <section className="relative overflow-hidden bg-metallic-emerald-deep py-14 text-metallic-ivory sm:py-16">
        ...
        <div className="relative mx-auto max-w-4xl px-4 text-center sm:px-6 lg:px-8">
          <Reveal>
            <h2 className="font-display text-2xl font-bold tracking-tight sm:text-3xl text-metallic-ivory">Ready for an exact, all-inclusive quote?</h2>
