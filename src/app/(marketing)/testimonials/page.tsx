        ...
        <div className="relative mx-auto max-w-7xl px-4 py-14 sm:px-6 sm:py-20 lg:px-8">
          <Reveal>
            <div className="mx-auto max-w-2xl text-center">
              <span className="mb-4 inline-flex items-center gap-1.5 rounded-full border border-metallic-bronze-top/40 bg-metallic-emerald-deep/60 px-4 py-1.5 font-mono text-xs font-semibold uppercase tracking-[0.2em] text-metallic-bronze-top"><Award className="h-3.5 w-3.5" /> Customer Reviews</span>
              ...
              <div className="mt-6 inline-flex items-center gap-3 rounded-full border border-metallic-ivory/25 bg-metallic-emerald-deep/60 px-5 py-2.5 shadow-sm">
                <div className="flex">
                  {[0, 1, 2, 3, 4].map((i) => (
                    <Star key={i} className="h-5 w-5 fill-amber-400 text-amber-400" />
                  ))}
                </div>
                <span className="text-lg font-bold text-metallic-ivory">{siteConfig.rating.value}</span>
                <span className="text-sm text-metallic-ivory/70">/ 5 · {siteConfig.rating.count.toLocaleString()}+ reviews</span>
              </div>
            </div>
          </Reveal>
        </div>
